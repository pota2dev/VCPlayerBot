...
buttons = [
    [
        ...
        InlineKeyboardButton('🥔OWNER🥔', url='https://t.me/PotatoTheGreat'),
    ]
    ]
def get_cmd(dur):
    if dur:
...
async def search(client, query):
    ...
    if query.query == "ETHO_ORUTHAN_PM_VANNU":
        answers.append(
            InlineQueryResultArticle(
                title="Deploy",
                input_message_content=InputTextMessageContent(f"{Config.REPLY_MESSAGE}\n\n<b>I'm just a bot to play music. I don't have time to talk to you.</b>", disable_web_page_preview=True),
